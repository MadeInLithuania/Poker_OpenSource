...
namespace Poker
{
    public partial class Play : Form
    {
        ...
        List<Cartes> jeu = new List<Cartes>()
        {
            ...
            new Cartes() { Valeur  = 2, Image = Environment.CurrentDirectory + "\\img\\2H.png"},
            new Cartes() { Valeur  = 3,  Image = Environment.CurrentDirectory + "\\img\\3H.png"},
            new Cartes() { Valeur  = 4,  Image =Environment.CurrentDirectory + "\\img\\4H.png"},
            new Cartes() { Valeur  = 5,  Image =Environment.CurrentDirectory + "\\img\\5H.png"},
